...
API_ID = int(environ.get('API_ID', '21643763')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '9ab0b0e819951db76417c7e4962ccdf5')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "7262086950:AAEGJsxnD9UeKwLUnkTueikhVofTwuyho6w")    # Bot token from @BotFather
...
PICS = (environ.get('PICS', 'https://envs.sh/4Y1.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5095951697').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001448525970').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003103968429'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003103968429'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003103968429'))  # Premium logs channel id
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002767321414')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002767321414")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002711680347")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Rahul:Rahulalppatta@cluster0.vswch4c.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003122962999'))  # Notification of sent to your channel
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/thamburanmovies') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 't.me/rgthamburan') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+oXERLQPdb-ExZTU1') # Update channel link for the bot
...
MAX_B_TN = environ.get("MAX_B_TN", "5") # Maximum number of buttons in a row (default: )
