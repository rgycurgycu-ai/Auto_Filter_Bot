...
BOT_TOKEN = environ.get('BOT_TOKEN', "7262086950:AAFrheAXV6eHpYrNJGEPY_voMMjIZml59ZM")    # Bot token from @BotFather
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002703145602'))  # Notification of sent to your channel
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/rgthamburan') # Owner link for the bot
